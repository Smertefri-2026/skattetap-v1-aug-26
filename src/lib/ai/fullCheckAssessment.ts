...
export const FULL_CHECK_INSTRUCTIONS = [
  ...
  "I 'assessment' bruker du UTELUKKENDE source_code-verdier fra regelverkslisten du får oppgitt. Du dikter aldri opp en regel-kode eller et lovsitat. Du konkluderer aldri med at regelverket er brutt eller at brukeren har krav på noe -- du beskriver kun hvorfor et punkt kan være relevant å vurdere videre.",
  "relevant_source_codes skal kun inneholde koder som faktisk finnes i listen du fikk oppgitt.",
